...
namespace AvaTwin
{
    ...
    public static class AvaTwinPlayer
    {
        ...
        /// <summary>
        /// Optional external user identifier. Used by Agency-tier customers
        /// who want to integrate their own user identity system instead of
        /// using Ava-Twin's built-in login panel.
        ///
        /// When set (non-null and non-empty), the value is sent as
        /// <c>external_user_id</c> on player-* requests (guest-init, login,
        /// avatar-save). When null/empty, the field is omitted and the
        /// server falls back to its default player_id behavior.
        ///
        /// Set this once at app startup, before calling
        /// <see cref="InitGuestAsync"/> or <see cref="LoginAsync"/>.
        /// </summary>
