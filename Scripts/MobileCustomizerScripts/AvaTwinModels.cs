...
public class TokenMintResponse
{
    ...
    // Server populates this only when mode=editor. Null for embed/playground
    // mints. EditorQuota is defined in PlayerModels.cs (same AvaTwin namespace).
    // Newtonsoft.Json deserializes public fields by default, so no JsonProperty
    // attribute is needed on the inner fields — the field names already match.
    [JsonProperty("editor_quota")] public EditorQuota editor_quota;
}
...
public class AvatarVariation
{
    ...
    [JsonProperty("default_skin_tone")] public string defaultSkinTone;
}
...
[System.Serializable]
public class SdkAvatarSaveResponse
{
    [JsonProperty("success")] public bool success;
    [JsonProperty("avatar_id")] public string avatar_id;
    [JsonProperty("player_id")] public string player_id;
    [JsonProperty("error")] public string error;
}
}