...
| ![Android](https://img.shields.io/badge/Android-Supported-brightgreen) | Native in-app customizer |
| ![iOS](https://img.shields.io/badge/iOS-Supported-brightgreen) | Native in-app customizer |
...
```
https://github.com/waqaszs/ava-twin-unity-sdk.git#v1.1.0
```
...
- **Android/iOS:** Opens the native in-app customizer with category tabs, skin tone picker, and avatar preview
